...
Multi-arch tamago ISO assembly and the QEMU/EDK2 4-arch boot test
harness moved to a separate repo: github.com/cloud-boot/iso
(cloud-boot-iso CLI + pkg/iso + pkg/multiarchboot library API).`,
		SilenceUsage: true,
	}
